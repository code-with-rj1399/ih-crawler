...
public class InterviewPost {
    ...
    public String getRawCompany() { return rawCompany; }
    public void setRawCompany(String rawCompany) { this.rawCompany = rawCompany; }
    public String getRawRole() { return rawRole; }
    public void setRawRole(String rawRole) { this.rawRole = rawRole; }
    ...
    public void setExtracted(boolean extracted) { this.extracted = extracted; }
    public JsonNode getExtractionJson() { return extractionJson; }
    public void setExtractionJson(JsonNode extractionJson) { this.extractionJson = extractionJson; }
